      ...
      >
        ...
        >
          ...
          >
            ...
            <div class="text-sm text-red-400" v-if="form.errors.uri">
              {{ form.errors.uri }}
            </div>
          </FormControl>
        </FormField>
        ...
        >
          <FormControl
            v-model="form.icon"
            type="text"
            placeholder="Copiez juste le nom de votre icon depuis @mdi"
            :error="form.errors.icon"
          >
            <div class="text-sm text-red-400" v-if="form.errors.icon">
              {{ form.errors.icon }}
            </div>
          </FormControl>
        </FormField>
