...
<template>
  ...
  <!--     
    <footer class="py-5 text-white bg-black">
      <div class="text-center md:pied_page">
        <nav class="pied_nav">
          <ul class="justify-around md:flex md:items-center">
            <li>
            ...
            <li>
              <a href="/actualite" class="px-3 py-2 font-medium hover:text-gray-300"
                >Actualité</a
              >
            </li>
          </ul>
        </nav>
        <div class="inline-flex justify-center logo_img">
          <div class="logo_pied">
            <a href="#"
              ><img
          ...
          <span
            class="inline-flex justify-center mt-2 sm:ml-auto sm:mt-0 sm:justify-start media_sociaux"
          >
            <a class="text-gray-500 cursor-pointer hover:scale-105">
              <svg
                ...
                stroke-width="2"
                class="w-10 h-10 rounded-full border-2 border-[#E69803] px-2"
                viewBox="0 0 24 24"
              >
                <path
            ...
            <a class="ml-3 text-gray-500 cursor-pointer hover:scale-105">
              <svg
                ...
                stroke-linejoin="round"
                stroke-width="2"
                class="w-10 h-10 rounded-full border border-2 border-[#E69803] px-2 "
                viewBox="0 0 24 24"
              >
                <path
  ...
  <footer class="bg-white dark:bg-gray-900">
    <div class=" px-6 py-12 mx-auto  bg-[#121212]">

      <nav class="container pied_nav">
        <ul class="justify-around md:flex md:items-center">
          <li>
            <a href="/LeGroupe" class="px-3 py-2 font-medium text-white hover:text-gray-300">Le Groupe</a>
          </li>
          <li>
            <a href="#" class="px-3 py-2 font-medium text-white hover:text-gray-300">Prestations</a>
          </li>
          <li>
            <a href="#" class="px-3 py-2 font-medium text-white hover:text-gray-300">Vous accompagner</a>
          </li>
          <li>
            <a href="#" class="px-3 py-2 font-medium text-white hover:text-gray-300">RSE</a>
          </li>
          <li>
            <a href="#" class="px-3 py-2 font-medium text-white hover:text-gray-300">Contacts</a>
          </li>
          <li>
            <a href="#" class="px-3 py-2 font-medium text-white hover:text-gray-300">Recrutements</a>
          </li>
          <li>
            <a href="#" class="px-3 py-2 font-medium text-white hover:text-gray-300">Mention Légal</a>
          </li>
          <li>
            <a href="/actualite" class="px-3 py-2 font-medium text-white hover:text-gray-300">Actualité</a>
          </li>
        </ul>
      </nav>
      ...
      <div class="container flex items-center justify-between mx-auto">
        <a href="#">
          <img class="w-auto h-10" src="/images/Logo_eclat.png" alt="">
        </a>
