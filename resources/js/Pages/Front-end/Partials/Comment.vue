    ...
    <section class=" dark:bg-gray-900 py-8 lg:py-16 antialiased">
        <div class=" px-4">
            ...
            <form class="mb-6">
                ...
                <button type="submit"
                    class="inline-flex items-center py-2.5 px-4  font-medium text-center  bg-primary-700 rounded-lg focus:ring-4 focus:ring-primary-200 dark:focus:ring-primary-900 hover:bg-primary-800">
                    Commentaires
                </button>
            </form>
