    ...
    <MainLayout>
        ...
        <div class="2xl:flex justify-center mt-8 xl:mx-0 md:px-20 xl:px-10 px-5">
            ...
            <div class="2xl:w-6/12 lg:w-8/12 md:container  md:mx-auto 2xl:mx-0  ">
                <div class="flex text-sm items-center justify-between pb-4 italic border-b">
                ...
                <div class="relative flex items-center justify-between pt-8 border-t border-gray-300"
                    ...
                    <div v-if="hasPrevious" @click="previousPost(props.post.id)"
                        ...
                        <span
                            class="p-2 md:p-4 text-sm md:text-lg font-bold text-white bg-gray-800 rounded-lg shadow-md hover:scale-50 hover:bg-gray-900">
                            Article précédent
                        </span>
                    </div>
                    <div v-if="hasNext" @click="nextPost(props.post.id)"
                        ...
                        <span
                            class="p-2 md:p-4 text-sm mb-5 md:text-lg font-bold text-white bg-gray-800 rounded-md shadow-lg hover:scale-50 hover:bg-gray-900">
                            Article suivant
                        </span>
                    </div>
                </div>
