...
! function () {
    ...
    var n, o = tinymce.util.Tools.resolve("tinymce.PluginManager"),
    ...
    function F(t, n, r) {
        return void 0 === r && (r = !1), new I(function (e) {
            ...
            a.onreadystatechange = function () {
                ...
                }, a.open("GET", t, !0), a.withCredentials = r,
                function (e) {
    ...
    function B(e) {
        var t, n = (t = e, "ImageProxy HTTP error: " + x(J, function (e) {
            return t === e.code
    ...
    function ee(e) {
        return t = X.fromDom(e), n = "img", r = function (r) {
            return function (e) {
                var t = r.dom;
    ...
    function ce(e, t) {
        var n, r, o = e.editorUpload.blobCache.getByUri(t.src);
    ...
    function fe(u, c, s, f, l, d, m) {
        return s.toBlob().then(function (e) {
            var t, n, o, r = u.editorUpload.blobCache,
                i = d.src,
                a = c.type === e.type;
