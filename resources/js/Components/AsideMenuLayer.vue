    ...
    >
      ...
      >
        <div class="flex-1 w-20 text-center lg:text-left lg:pl-6 xl:text-center xl:pl-0 ">
          <div class="flex flex-col items-center justify-center h-10 mx-auto mt-2 w-36">
            <ApplicationLogo/>
            <div class="ml-6 text-xs font-bold text-gray-500 text-bold-800 dark:text-white">DASHBOARD</div>
          </div>
