...
<template>
  <nav
    class="fixed top-0 left-0 right-0 z-30 w-screen bg-gray-50 h-14 transition-position xl:pl-60 lg:w-auto dark:bg-slate-800"
  >
    <div
    ...
    >
      ...
      <div
        class="absolute left-0 w-screen shadow top-14 bg-gray-50 lg:w-auto lg:items-stretch lg:flex lg:grow lg:static lg:border-b-0 lg:overflow-visible lg:shadow-none dark:bg-slate-800"
